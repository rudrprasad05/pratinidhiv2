...
import { UpdateBanner, UpdateProfilePic } from "@/actions/branch";
import { useRouter } from "next/navigation";

const UploadBannerDialogue = ({
  branch,
  children,
}: {
  branch: BranchType;
  ...
  const handleUpdateDatabase = async () => {
    await UpdateBanner(imageUrl, branch.id);
  };
...
export default UploadBannerDialogue;
